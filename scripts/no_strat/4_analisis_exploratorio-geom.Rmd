...
ggplot(data = prov) + 
  geom_sf() +
  geom_sf(data = datos, aes(color=dens_poblacion),size = 1.2, alpha = 0.6) +
  scale_color_gradientn(colours = rainbow(5,rev=T)) +
  # scale_color_gradient(low="blue", high="red")+

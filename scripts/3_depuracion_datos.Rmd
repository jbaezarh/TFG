...
Los valores perdidos de pendiente, orientación y curvatura se encuentran todos en los límites de Andalucía, como se muestra en el siguiente gráfico. Esto nos indica que la causa de que estos valores no estén disponibles es precisamente la discrepancia entre los 
distintos sistemas de referencia o entre los distintos polígonos utilizados para delimitar el territorio 
...
La cuestión principal es qué hacer con los años 2000 y 2001, porque los demás está claro que se van a imputar, pues son meses aislados. Las opciones son:
...
En este caso, se opta por la primera opción y se reduce el marco temporal del estudio a los años 2000 a 2001. 
...
Las observaciones para las que el NDVI no está disponible aunque si existe el archivo raster con la información para ese mes son debidas a que discrepancias entre los límites de los polígonos. Como en casos anteriores, se eliminan ya que son solo 16:

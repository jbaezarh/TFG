...
# save(models, file="Private/all_models_test.RData")
...
library(terra) # Raster data
library (mapSpain) # Regiones España
...
g = prov %>% 
  ...
  theme(axis.text.x=element_blank(),
        ...
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) +
  geom_sf(data=st_as_sfc(bbox),fill="transparent",lwd=1, col="black") # Añadir el recuadro

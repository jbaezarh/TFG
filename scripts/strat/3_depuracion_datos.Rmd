...
<!-- https://desktop.arcgis.com/es/arcmap/latest/manage-data/raster-and-images/curvature-function.htm -->
    ...
    - poblacion: Número de habitantes del municipio ese año.
    
    - dens_poblacion: Densidad de población del municipio ese año.
...
Dada la reducida cantidad de observaciones con valores perdidos, se opta directamente por eliminarlas.
...
A continuación se detalla un análisis de los valores faltantes de cada variable.

...
library(nasapower) # Obtención de información meteorológica
...
# Eliminamos las observaciones que no tienen fecha porque se pueden usar para el estudio
...
ferrocarril <- read_sf("data_raw/antropologicas/Ferrocarril/09_21_Ferrocarril.shp") |> 
  st_union()
dataset$dist_ferrocarril <- st_distance(dataset,ferrocarril) |> 
  as.numeric()

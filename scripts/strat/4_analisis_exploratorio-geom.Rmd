...
ggplot(data = prov) + 
  geom_sf() +
  geom_sf(data = datos, aes(color=T2M),size = 1, alpha = 0.6) +
...
ggplot(data = prov) + 
  geom_sf() +
  geom_sf(data = datos, aes(color=RH2M),size = 1, alpha = 0.6) +
  facet_wrap(~month(date,label=TRUE))+
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
        axis.text.y=element_blank(),
...
ggplot(data = prov) + 
  geom_sf() +
  geom_sf(data = datos, aes(color=WS10M),size = 1, alpha = 0.6) +
  scale_color_gradientn(colours = rainbow(5,rev=T)) +
  facet_wrap(~month(date,label=TRUE))+
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
ggplot(data = prov) + 
  geom_sf() +
  geom_sf(data = datos, aes(color=WD10M),size = 1, alpha = 0.6) +
  facet_wrap(~month(date,label=TRUE))+
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
        axis.text.y=element_blank(),
...
ggplot(data = prov) + 
  geom_sf() +
  geom_sf(data = datos, aes(color=NDVI),size = 1, alpha = 0.6) +
  facet_wrap(~month(date,label=TRUE))+
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
        axis.text.y=element_blank(),

...
\tightlist
\item
  Importancia de los bosques y de su monitorización para una adecuada
  gestión
\item
  Papel de los incendios forestales en el ecosistema.Influencia del
  humano. Consecuencias de los incendios para las personas
\item
  Efectos del cambio climático y factor humano
\item
  Dificultad de la predicción de incendios forestales y necesidad de la
  misma
\item
  Uso de AI y ML para abordar el problema
\item
  Enfoque del trabajo presente
\end{enumerate}
...
\item
  ...
  y la construcción de modelos de Machine Learning para la predicción
  del riesgo de incendio forestal en Andalucía a partir de un estudio
  previo del problema.
\item

...
\cleardoublepage   
<!--  \clearpage -->
\section*{Agradecimientos}  <!--Cambiar por si se necesita:  Agradecimientos -->
\addcontentsline{toc}{section}{Agradecimientos} <!-- Agradecimientos -->
<!-- agradecimientos.Rmd -->

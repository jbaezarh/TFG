...
En el segundo capítulo se han introducido los principales conceptos y las principales herramientas utilizadas a lo largo del trabajo. Se han explicado brevemente todos los modelos empleados, indicando referencias en las que poder ahondar en los detalles de estos. 

<!-- Justificar en la sección 3 el por qué del método de muestreo elegido -->
En el tercer capítulo se han procesado los conjuntos geoespaciales recopilados para producir un conjunto de datos adecuado para el análisis estadístico. Esto se ha llevado a cabo en tres etapas: generación de la muestra, asignación de variables a localizaciones y depuración de los datos. 

Dado que para poder entrenar los modelos considerados es necesario disponer de 

...
<!-- El control y extinción de los incendios forestales requiere del desplazamiento de un gran número de efectivos, y el éxito en la operación depende en muchos casos de la velocidad en la respuesta. -->
...
- Todos los conjuntos de datos recopilados, así como los generados a través del procesamiento de estos y todo el código empleado, se encuentran disponibles en el repositorio \url{https://github.com/jbaezarh/TFG}.
...
- Explorar vías de mejora del modelo de *Random Forest*, desentrañando las causas del pobre rendimiento obtenido para valores moderados de $min\_n$ que han llevado a considerar árboles poco profundos, lo cual ha podido tener un impacto negativo en el desempeño final de este modelo.

- Usar de modelos de *Deep Learning* como redes convolucionales podría traer mejoras significativas en los modelos, al considerar la estructura de correlaciones espaciales presentes en los datos [@SpainOnFire].

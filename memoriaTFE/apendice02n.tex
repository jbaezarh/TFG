...
\NormalTok{    points}\SpecialCharTok{$}\NormalTok{clim\_id }\OtherTok{=} \ConstantTok{NA} \CommentTok{\# Se inicializa el identificador}
...
\NormalTok{  municipios }\OtherTok{\textless{}{-}} \FunctionTok{esp\_get\_munic}\NormalTok{(}\AttributeTok{epsg =} \DecValTok{4258}\NormalTok{,}\AttributeTok{region =} \StringTok{"Andalucía"}\NormalTok{) }\SpecialCharTok{|\textgreater{}} 
...
\NormalTok{          NDVI\_rast }\OtherTok{=} \FunctionTok{as.numeric}\NormalTok{(}\FunctionTok{rast}\NormalTok{(ruta))}
          \ControlFlowTok{if}\NormalTok{ (MONTH}\SpecialCharTok{==}\DecValTok{4} \SpecialCharTok{\&}\NormalTok{ YEAR}\SpecialCharTok{==}\DecValTok{2011}\NormalTok{)\{}
            ...
            \FunctionTok{crs}\NormalTok{(NDVI\_rast) }\OtherTok{=} \FunctionTok{crs}\NormalTok{(}\FunctionTok{rast}\NormalTok{(}
              \StringTok{"data\_raw/vegetacion/2011TERMODMEDMNDVI/InfGeografica/InfRaster/TIF/TERMOD\_110501\_h17v05\_medmndvi.tif"}\NormalTok{))}
\NormalTok{              \} }
...
\hypertarget{anuxe1lisis-univariantes-1}{%
\subsection{Análisis univariantes}\label{anuxe1lisis-univariantes-1}}

\hypertarget{t2m-1}{%
\subsubsection*{T2M}\label{t2m-1}}
...
\hypertarget{rh2m-1}{%
\subsubsection*{RH2M}\label{rh2m-1}}
...
\hypertarget{gwettop-1}{%
\subsubsection*{GWETTOP}\label{gwettop-1}}
...
\hypertarget{ws10m-1}{%
\subsubsection*{WS10M}\label{ws10m-1}}
...
\hypertarget{wd10m-1}{%
\subsubsection*{WD10M}\label{wd10m-1}}
...
\hypertarget{prectotcorr-1}{%
\subsubsection*{PRECTOTCORR}\label{prectotcorr-1}}
...
\hypertarget{ndvi-1}{%
\subsubsection*{NDVI}\label{ndvi-1}}
...
\hypertarget{poblacion-1}{%
\subsubsection*{poblacion}\label{poblacion-1}}
...
\hypertarget{dens_poblacion-1}{%
\subsubsection*{dens\_poblacion}\label{dens_poblacion-1}}
...
\hypertarget{elevacion-1}{%
\subsubsection*{elevacion}\label{elevacion-1}}
...
\hypertarget{curvatura-1}{%
\subsubsection*{curvatura}\label{curvatura-1}}
...
\hypertarget{dist_carretera-1}{%
\subsubsection*{dist\_carretera}\label{dist_carretera-1}}
...
\hypertarget{dist_electr-1}{%
\subsubsection*{dist\_electr}\label{dist_electr-1}}
...
\hypertarget{dist_camino-1}{%
\subsubsection*{dist\_camino}\label{dist_camino-1}}
...
\hypertarget{dist_sendero-1}{%
\subsubsection*{dist\_sendero}\label{dist_sendero-1}}
...
\hypertarget{dist_poblacion-1}{%
\subsubsection*{dist\_poblacion}\label{dist_poblacion-1}}
...
\hypertarget{dist_ferrocarril-1}{%
\subsubsection*{dist\_ferrocarril}\label{dist_ferrocarril-1}}
...
\hypertarget{bosques-aleatorios-1}{%
\subsection{Bosques aleatorios}\label{bosques-aleatorios-1}}
...
\hypertarget{aplicaciuxf3n-de-los-modelos-1}{%
\section{Aplicación de los
modelos}\label{aplicaciuxf3n-de-los-modelos-1}}

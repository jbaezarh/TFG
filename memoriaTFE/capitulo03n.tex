...
Sobre este conjunto de datos se realizará en el {[}capítulo
4{]}{[}Análisis exploratorio de datos{]} un análisis exhaustivo de las
variables y de las relaciones entre las mismas, que proporcionará un
conocimiento esencial para llevar a cabo los modelos predictivos objeto

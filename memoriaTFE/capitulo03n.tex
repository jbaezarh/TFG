...
(da más de 100ha) en un momento concreto.
...
En la tabla \ref{tab:fuentes} se muestra algo
...
\multirow{6}{*}{Meteorológicas} & Precipitación (mm/day)                                         & NASA POWER\tnote{e} & df / raster (0.5º) & Diaria     \\
                                ...
                                & Dirección del viento a 10 metros sobre la superficie terrestre & NASA POWER & df / raster (0.5º) & Diaria     \\
...
Tras una extensa revisión de estudios similares (\ldots), se ha optado
por usar un conjunto de {[}22{]}

Siguiendo el ejemplo de otros trabajos similares (\ldots) se ha optado
por usar un conjunto de {[}22{]} variables predictoras que pueden
clasificarse en las siguientes 5 categorías:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  Topográficas Altitud Orientación Pendiente Curvatura
\item
  Vegetación. NDVI
\item
  Antropogénicas Distancia a población Uso de suelo Distancia a
  carreteras Distancia a Ferrocarril Distancia a Línea eléctrica
  Distancia a Espacio protegido Distancia a Sendero / Vía Verde / Carril
  Bici Distancia a Camino / Vía Pecuaria
\end{enumerate}
...
\setcounter{enumi}{3}
\item
  Hidrográficas Precipitación (mm/day) Distancia a ríos
\item
  Meteorológicas Temperatura a 2m sobre la superficie (º) Humedad del
  suelo (\%) Dirección del viento a 10 metros sobre la superficie
  terrestre Humedad relativa a 2m sobre la superficie (\%) Cantidad de
  precipitaciones (mm/day) Radiación solar incidente al medio día
  (MJ/m\^{}2/day)
\end{enumerate}

Fecha Municipio y código municipio

\hypertarget{fuentes-de-datos-1}{%
\section{Fuentes de datos}\label{fuentes-de-datos-1}}

...
\begin{figure}[h]
\centering
\includegraphics[width =\textwidth]{graficos/roc_validation.png}
...
Por último, evaluamos el rendimiento de estos modelos sobre el conjunto de datos test, formado por las observaciones de junio de 2019 en adelante. Para entrenar los modelos s

\ref{fig:test_metrics} \ref{fig:roc_test}
...
\begin{figure}[h]
\centering
\includegraphics[width =\textwidth]{graficos/test_metrics.png}
...
\begin{figure}[h]
\centering
\includegraphics[width =\textwidth]{graficos/roc_test.png}

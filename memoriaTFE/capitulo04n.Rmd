...
\caption[Diagrama de caja y bigotes de cada variable numérica en función de la variable objetivo]{Diagrama de caja y bigotes de cada variable numérica en función de la variable objetivo. \it Fuente: Elaboración propia.}
\label{fig:boxplots}
\end{figure}
...
## Análisis multivariante de las variables numéricas
